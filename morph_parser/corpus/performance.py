"""
Performance optimization utilities for morph_parser.
...
Example:
    Using automatic caching::
        ...
        from morph_parser.corpus.performance import cached_result
    ...
    Memory optimization for large corpora::
        ...
        from morph_parser.corpus.performance import MemoryOptimizer
    ...
    Performance monitoring::
        ...
        from morph_parser.corpus.performance import PerformanceMonitor
...
class PerformanceCache:
    ...
    def __init__(self, cache_dir: Optional[str] = None, max_size: int = 100):
        default_cache = str(Path.home() / ".morph_parser_cache")
